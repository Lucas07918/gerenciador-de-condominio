...
const MessageStack = ({navigation}) => (
    <Stack.Navigator>
        ...
        options={{headerStyle: {backgroundColor: '#3e92d1'}, headerTintColor: '#fff'}}/>
        <Stack.Screen 
        name="Chat" 
        component={ChatScreen}
        options={({route}) => ({
            title: route.params.userName,
            headerStyle: {backgroundColor: '#3e92d1'},
            headerTintColor: '#fff'
        })}
        />
    </Stack.Navigator>
...
const TabNavigator = () => {
    ...
    <Tab.Navigator screenOptions={{
        ...
        tabBarStyle: {backgroundColor: '#206ba3'},
        tabBarInactiveTintColor: '#555',
        tabBarActiveTintColor: '#3e92d1'
    }}>
        ...
        <Tab.Screen name="Message" component={MessageStack} options={({route}) => ({
            tabBarBadge: 3,
            tabBarBadgeStyle: {backgroundColor: '#3e92d1', color: '#fff'},
            tabBarStyle: {display: getTabBarVisibility(route), backgroundColor: '#fff', borderRadius: 90, position: 'absolute', marginHorizontal: 25, marginBottom: 15, height: 60},
            tabBarIcon: ({color, size}) => (
