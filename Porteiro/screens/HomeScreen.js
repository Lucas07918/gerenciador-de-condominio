            ...
            <View style={{padding:0, alignItems:'center'}} >
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{
                        ...
                        borderColor: '#3333',
                        width: 200
                    }}><Text style={{fontSize: 20, color:'#3e92d1'}}>Entregas</Text></TouchableOpacity>
                    ...
                    <TouchableOpacity style={{
                        ...
                        borderColor: '#3333',
                        width: 200
                    }}><Text style={{fontSize: 20, color:'#3e92d1'}}>Contas</Text></TouchableOpacity>
                    ...
                    <TouchableOpacity style={{
                        ...
                        borderColor: '#3333',
                        width: 200
                    }}><Text style={{fontSize: 20, color:'#3e92d1'}}>Agendamentos</Text></TouchableOpacity>
                    ...
                    <TouchableOpacity style={{
                        ...
                        alignItems:'center',
                        width: 200
                    }}><Text onPress={() => {}} style={{fontSize: 20, color:'#3e92d1'}}>Chamados</Text></TouchableOpacity>
                </View>
                {/* <View style={{
                    flexDirection:'row', 
                    borderColor:'#C6C6C6', 
