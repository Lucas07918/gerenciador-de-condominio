...
const MessageStack = ({navigation}) => (
    <Stack.Navigator>
        ...
        options={{headerStyle: {backgroundColor: '#19ba67'}, headerTintColor: '#fff'}}/>
        <Stack.Screen 
        name="Chat" 
        component={ChatScreen}
        options={({route}) => ({
            title: route.params.user,
            headerStyle: {backgroundColor: '#19ba67'},
            headerTintColor: '#fff'
        })}
        />
        <Stack.Screen name="Contacts" component={ContactsScreen} 
        options={{title: "Select Contacts", headerStyle: {backgroundColor: '#19ba67'}, headerTintColor: '#fff'}}/>
    </Stack.Navigator>
)
